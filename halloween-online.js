(function () {
  ...
  function start() {
    ...
    products.forEach(function (item) {
      ...
      card.innerHTML = '<img src="' + item[0] + '" alt="' + item[1] + '"><div class="online-halloween-info"><b>' + item[1] + '</b><button type="button">Agregar al carrito</button></div>';
